...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("MORICEUG,256707521863")
...
module.exports = {
  ...
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'MORICEUG-Md' : process.env.PACK_INFO.split(";")[1],
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'MORICE UG IS THE OWNER OF MORICE DESIGNZ LTD AND HE'S ACTIVE ALL DAY' : process.env.ALIVE_MESSAGE,
  ...
  LANG: process.env.THEME|| 'MORICEUG',
